...
class r0SimpleToolbox_PG_ExportEntryItem(bpy.types.PropertyGroup):
    ...
    is_settings_fbx_expanded: BoolProperty(name="FBX", description="Unfold/Collapse section for FBX Export Settings", default=False)  # type: ignore

    is_options_expanded: BoolProperty(name="Options", description="Unfold/Collapse section for FBX Export Settings", default=False)  # type: ignore

    use_custom_fbx_settings: BoolProperty(
